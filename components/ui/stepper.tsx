    ...
    >
      <div
        ...
        className={cn(
          ...
          "data-[orientation=horizontal]:w-full data-[orientation=horizontal]:flex-row data-[orientation=horizontal]:items-center",
    ...
    >
      <div
        ...
        className={cn(
          ...
          "group-data-[orientation=horizontal]/stepper:flex-row group-data-[orientation=horizontal]/stepper:flex-1",
          "group-data-[orientation=vertical]/stepper:flex-col group-data-[orientation=vertical]/stepper:items-start",
          className
        )}
        data-state={state}
