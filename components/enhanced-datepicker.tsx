...
// Import des locales - corrigé
const getLocale = async (locale: "fr" | "en" | "es"): Promise<Locale | undefined> => {
  switch (locale) {
    case "fr":
...
export function EnhancedDatePicker({
  ...
  // Chargement asynchrone de la locale
  useEffect(() => {
    getLocale(locale).then(setSelectedLocale)
  }, [locale])
  ...
  const CalendarComponent = () => (
    <Calendar
      ...
      captionLayout={showYearSelect || showMonthSelect ? "dropdown" : undefined}
