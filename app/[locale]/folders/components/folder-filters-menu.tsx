...
const FILTER_CONFIGS: Record<StatusCategory, FilterConfig> = {
  ...
  active: {
    ...
    options: {
      ...
      // ],
      processing_stage: [
        { value: 'intake', label: 'Prise en charge' },
        { value: 'documentation', label: 'Documentation' },
        { value: 'customs_clearance', label: 'Dédouanement' },
        { value: 'inspection', label: 'Contrôle/Inspection' },
        { value: 'storage', label: 'Stockage' },
        { value: 'preparation', label: 'Préparation livraison' },
